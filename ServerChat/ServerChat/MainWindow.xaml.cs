...
namespace ServerChat
{
    public sealed partial class MainWindow : Window
    {
        ...
        private const int sendPort = 13001;    // Send to client
        private const int listenPort = 13000;  // Listen from client
        ...
        private void SendMessage(string message)
        {
            try
            {
                TcpClient client = new TcpClient("127.0.0.1", sendPort); // Send to client
